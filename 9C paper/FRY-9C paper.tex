...
\section{Comparison of data in FR Y-9C with other reports submitted to the Federal Reserve}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{|l|p{7cm}|}
			...
			\hline
			FR Y-15        & Consolidated performance and condition report for large bank holding companies. \\
			\hline
			FR Y-11        & Parent company only financial statements for savings and loan holding companies. \\
			\hline
			FFIEC-002      & Report of assets and liabilities of U.S. branches and agencies of foreign banks. \\
			\hline
			FFIEC-031      & Consolidated report of condition and income for banks with domestic offices only. \\
			\hline
			FFIEC-041      & Consolidated report of condition and income for banks with domestic and foreign offices. \\
			\hline
		\end{tabular}
		\label{tab:fed_forms}
	\end{table}
