...
\end{figure*}
	...
	\subsection{Discussion of Analytical themes available}
		...
		\subsection{Product analysis}
		 ...
		 Table \eqref{tab:loan_allowance} provides the allowance percentage for each category of real estate loans. At 1.04\% residential real estate loans have the lowest allowance as a percent of loans. Column 1 provides the amortized cost which is the annual payment - interest payments.
