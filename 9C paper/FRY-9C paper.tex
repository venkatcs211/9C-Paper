...
\end{figure*}
	...
	\subsection{Discussion of Analytical themes available}
		...
		\subsection{Product analysis}
		 ...
		 Concentration is the amount of assets of the bank present in one product like a loan or a derivative. Concentration can exist in individual loan segments like a home mortgage loan, commercial real estate loan or jumbo loan or a bullet loan and so on. Based on the concentration, the sensitivity of bank's portfolio to various shocks like the interest rates, inflation and liquidity of the banking book can be measured. 
